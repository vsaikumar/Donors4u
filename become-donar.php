...
$status=1;
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,pass,Age,Gender,BloodGroup,Address,hospital,status) VALUES(:fullname,:mobile,:email,:pass,:age,:gender,:blodgroup,:address,:hospital,:status)";
...
<head>
    ...
    <title>Donor4u| Become A Donar</title>
...
<div><input type="password" name="pass" class="form-control" required></div>
</div>
<div class="col-lg-4 mb-4">
...
<div><textarea class="form-control" name="hospital" required> </textarea></div>
</div>
</div>
