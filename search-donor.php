...
<head>
    ...
    <title>Donor4u|Search A Donar</title>
...
<?php include('header.php');?>
 ...
 <a href='donor/req.php' style="height: 50px;width: 100px;color: white;background-color: cyan;position: absolute;right: 30px;top: 70px;text-align: center;line-height: 50px;" >Request</a>
    <!-- Page Content -->
    <div class="container">
...
?></p>
     <p class="card-text"><b>Hospital :</b> <?php echo htmlentities($result->hospital);?></p>
