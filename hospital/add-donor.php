...
$message=$_POST['hospital'];
$status=1;
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,hospital,status) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status)";
...
<div class="col-sm-10">
<textarea class="form-control" name="hospital" required> </textarea>
</div>
</div>
